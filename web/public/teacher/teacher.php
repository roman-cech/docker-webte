...
if (isset($_POST['first-short-q'])) {
  ...
  //  echo $_SESSION['newToken'];
    ...
    $controller->insertAnswers($userID, $questionId++, "Výber správnej odpovede", implode(",", $firstMoreAnswer), $correctAnswer2);
    ...
    $controller->insertAnswers($userID, $questionId++, "Výber správnej odpovede", implode(",", $secondMoreAnswer), $correctAnswer);
                    ...
                    <div class="container">
                        <form action="teacher.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="correctAnswer"><strong>Spravna odpoved</strong></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="correctAnswer2"><strong>Spravna odpoved2</strong></label>
                                <input type="text" name="correctAnswer2" id="correctAnswer2"><br>
                            </div>
