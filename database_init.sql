...
-- Čas generovania: Št 06.Máj 2021, 17:44
...
CREATE TABLE `Answers` (
  ...
  `additional_answer` varchar(128) COLLATE utf8_slovak_ci DEFAULT NULL
...
--
ALTER TABLE `Answers`
  ADD CONSTRAINT `Answers_ibfk_1` FOREIGN KEY (`question_id`) REFERENCES `Questions` (`answer_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Questions`
  ADD CONSTRAINT `Questions_ibfk_1` FOREIGN KEY (`exam_id`) REFERENCES `Exams` (`question_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
